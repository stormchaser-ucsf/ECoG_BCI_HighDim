function [r2] = run_regression_bci_swap(neural_data_b,kin_data_b,neural_data_a,kin_data_a,dim)



% split into training and testing -> pair action , build on one and test on
% another
overall_r2=[];
parfor iter=1:100
    ...
    test_neural = neural_data_b(test_idx);
    test_kin = kin_data_b(test_idx);
