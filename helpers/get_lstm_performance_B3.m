function [acc_lstm_sample,acc_mlp_sample,acc_lstm_trial,acc_mlp_trial] = ...
    get_lstm_performance_B3(filepath,net_bilstm,Params,lpFilt,num_targets)
...
for i=1:length(files)
    ...
    % create buffer
    data_buffer = randn(len,256)*0.05;
    ...
    for j=1:length(raw_data)
        ...
        neural_features = extract_lstm_features_onlineTrials_B3(data_buffer,Params,lpFilt);        
...
% looking at accuracy in terms of max decodes, trial level
